...
## Introduction
Trauma is a major cause of increasing death rates in India and a very important component of trauma care is prioritizing the patients on the basis of their level of sickness or injuries. Most common <!--mechanisms of trauma--> are road traffic injuries, falls, Occupational injuries and Assaults. Most of the deaths are occur in **golden hour** of trauma. So, its important to quickly assess the severity of injury accurately.
In Trauma care, how patients are prioritized so that patients are in need of care are seen first is important. This whole process of prioritizing the patients is called Triage and these priorities are coded using colors, e.g. **red, orange, yellow and green**, where red assigned to the most urgent patients and green to least urgent patients and orange and yellow comes in between red and green. After red, orange comes and then yellow and then green.

In trauma triaging we use physiological variebles such as **Blood pressure, respiratory rate, oxygen saturation level and GCS** to assess the level severity injuries of patients in our hospital.

## Aim
To study the different variables of patient with the history of trauma and patient codded as orange during triaging.

## Design
Prospective observational study was done on 523 patients came with the history of trauma in the emergency department of a public hospital. Out of these patients, some come directly and others are referred from the other hospitals.

## Methods
This was a study of trauma patient ≥ 18 years coming to emergency department of LoK Nayak Jai Prakash Hoaspital, Delhi. Mechanism of injury, details of incident, history, injuries were noted and vital signs were taken.
...
## Conclusion
Road Traffic Accident and falls are the major causes of trauma. Most of the patients in this category are between the age 18 to 30 (49%). RTA is the most commomn mechanism of injury (48%). Mortality rate of orange triaged patients are less than 1% (0.2%).
